...
<div class="custom-about-container">
  ...
  <div style="max-width: 100%; margin: 0 auto;">
    ...
    <div class="figma-hero-card">
      ...
      <div class="figma-banner-strip"></div>
      
      <div class="figma-profile-body">
        
        <div class="figma-avatar-row">
   
          <div class="figma-avatar-frame">
            <img src="../assets/my-photo.jpg" alt="Your Name — technical writer portrait">
          </div>
...
<div class="figma-stats-grid">
  ...
  <div class="figma-stat-card">
    <div class="figma-stat-number">10+</div>
    <div class="figma-stat-label">Years Experience</div>
  </div>
...
<div class="figma-skills-card"> <!--Skill card division -->
  
  <h2 class="figma-skills-title">Specializations</h2> <!--Skill title -->
...
<div class="figma-experience-card">
  
  <h2 class="figma-experience-title">Experience</h2>
  
  <div class="figma-timeline-container">
    
<!-- Job 1: Nexus Inc. -->
   <div class="figma-timeline-item">
